...
import { formatJPYPrice } from "../../lib/utils";
        ...
        <div className=" sm:flex">
          ...
          >
            ...
            <div className=" ml-2">
              ...
              <div className=" my-4 text-2xl font-bold"> {formatJPYPrice(product.price)} </div>
            ...
            <div className=" sm:flex w-full gap-4 mt-8 px-1">
              ...
              <button
                className=" flex justify-center items-center hover:scale-105 transition shadow-md
                 bg-primary text-xl px-8 py-2 text-white ring-1 ring-primary w-full sm:w-auto"
                onClick={() => {
                  // Add to cart first, then redirect to checkout or show buy now functionality
                  onAdd(product, qty);
                  // You can add additional buy now logic here (e.g., redirect to checkout)
